...
export class CountryCodePipe implements PipeTransform {
  ...
  private codeList = [
      ...
      { "code": "kp", "names": "North Korea, DPRK" },
      { "code": "kr", "names": "Korea, South Korea, ROK" },
  ...
  transform(value: string): string {
    let country = value
    let posicion = this.codeList.findIndex( c => c.code == value.toLowerCase())
    country = this.codeList[posicion].names
    return country;
  }
